...
var vGallery = function(config) {
    ...
    vg.computeIndicatorSize = function() {
        ...
        vg.in.bg = (vg.in.image) ?
            'url("'+vg.in.image+'") no-repeat' : vg.in.color;
        vg.in.active_bg = (vg.in.aimage) ?
            'url("'+vg.in.aimage+'") no-repeat' : vg.in.acolor;
    };
    ...
    vg.createGallery = function() {
        ...
        if (vg.loading.image) {
            ...
            $('#vg_loading').css('opacity', 0)
                .css('background', vg.bg_color+' url("'+ vg.loading.image+'") no-repeat;')
    ...
    vg.createThumbnailNavigator = function() {
        ...
        for (i = 0; i < vg.images.length * vg.th.iterations; i++) {
            ...
            var thumb_style = 'background: '+vg.bg_color+' url('+thumb+') no-repeat;'+
    ...
    vg.createButton = function(button, nav) {
        ...
        if (image) {
            var button_img_style = 'background: url('+image+') no-repeat ;'+
    ...
    vg.setBackground = function(e) {
        var background = vg.bg_color+' url('+vg.getImage()+') no-repeat';
